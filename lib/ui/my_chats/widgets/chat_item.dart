...
class _ChatItemState extends State<ChatItem> {
  ...
  late ReceivedMsgsProvider _receivedMsgsProvider;
              ...
              child: new Transform(
                  ...
                  child: LayoutBuilder(builder: (context, constraints) {
                    return GestureDetector(
                      onTap: () {
                        if (widget.chatMessage!.senderUserId != 0) {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => ChatScreen(
                                        senderId: widget
                                            ...
                                            .toString(),
                                        senderImg: widget
                                            .chatMessage!.messageSenderImage,
                                        senderName:
                              ...
                              Row(
                                children: <Widget>[
                                  ...
                                  Container(
                                    ...
                                    child: IconButton(
                                      onPressed: () async {
                                        _receivedMsgsProvider
                                            .setIsLoading(true);
                                        final results = await _apiProvider.get(Urls
                                                .DELETE_MESSAGE_URL +
                                            "?user1_id=${widget.chatMessage!.senderUserId}&user_id=${_authProvider.currentUser!.userId}");
                                        _receivedMsgsProvider
                                            .setIsLoading(false);
